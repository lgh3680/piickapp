...
&lt;div&gt;&lt;/div&gt;</pre>
		...
		disable: function(elem) {
			...
			if (nodeName.match(/input|textarea/)) {
				...
				elem.prepend('<div class="' + this._disableClass + '" style="width: ' +
					430 + 'px; height: ' + inline.outerHeight() +
  ...
  plugin.addKeyDef('ZORO2', 'zero2', function(inst) { plugin._selectValue(inst, '00'); }, true);
  plugin.addKeyDef('ZORO3', 'zero3', function(inst) { plugin._selectValue(inst, '000'); }, true);
