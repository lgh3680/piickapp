...
var nicUploadButton = nicEditorAdvancedButton.extend({
  ...
  uploadFile: function() {
    ...
    var B = $("input[name=textarea_img]")[0].files[0];
    console.log(B);
    ...
    this.setProgress(0);
    var A = new FormData();
    A.append("upload", $("input[name=textarea_img]")[0].files[0]);
    A.append("_action",'upload_image');
    A.append("_action_type", 'editor');
    A.append("_plugin", 'file');
    var C = new XMLHttpRequest();
    var formData = new FormData();
    C.open("POST", this.ne.options.uploadURI || "https://piick.co.kr");
